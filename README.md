...
- 进入定制界面后各种插件所对应的中文名字不懂的可以到这里《[添加插件应用说明]<a href="https://www.right.com.cn/forum/thread-3682029-1-1.html" target="_blank">click here!</a>》参考下，这个是恩山大神xtwz整理的，更新比较老，有个别没有的，参考看吧
